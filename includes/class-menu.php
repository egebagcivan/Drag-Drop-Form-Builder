...
function jotform_admin_menu() {
  add_menu_page('Jotform', 'Jotform', 'manage_options', 'jotform-admin-menu', 'jotform_admin_menu_main', get_menu_icon(), 70);
...
function jotform_admin_menu_main() {
  echo '<div class="wrap"><iframe src="http://jotform.com/myforms" frameborder="0" scrolling="yes" seamless="seamless" style="display:block; width:100%; height:100vh;"></iframe>
    </div>';
}
